! function (a, b) {
    ...
    p.alert = function () {
        ...
        if (f = b(n.form), d = {
            ...
            value: "",
            inputType: "text"
        }, a = m(j(d, arguments, ["title", "callback"]), ["confirm", "cancel"]), i = a.show === c ? !0 : a.show, a.message = f, a.buttons.cancel.callback = a.onEscape = function () {
    ...
    return p.addLocale = function (a, c) {
        return b.each(["OK","CONFIRM","CANCEL"], function (a, b) {
