    ...
    checkAll.prototype.init = function () {
        ...
        this.$el.on('change', function (e) {
            ...
            if ($(this).prop('checked')) {
                $(".btnsave, .btnremove, .btnhide, .btnreport, .btnremovehide, .btnspam, .btndelete").removeClass("disabled");
            } else {
                $(".btnsave, .btnremove , .btnhide, .btnreport, .btnremovehide, .btnspam, .btndelete").addClass("disabled");
            }
