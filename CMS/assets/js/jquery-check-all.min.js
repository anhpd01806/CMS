    ...
    checkAll.prototype.init = function () {
        ...
        this.$el.on('change', function (e) {
            ...
            if ($(this).prop('checked')) {
                $(".btnsave, .btnremove, .btnhide, .btnreport, .btnremovehide, .btnspam, .btndelete, .btncc").removeClass("disabled");
            } else {
                $(".btnsave, .btnremove , .btnhide, .btnreport, .btnremovehide, .btnspam, .btndelete, .btncc").addClass("disabled");
            }
