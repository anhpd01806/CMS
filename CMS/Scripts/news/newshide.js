    ...
    $(document).ready(function () {
        ...
        if (totalrecord > 0) {
            $('#listnewstable').DataTable({
                ...
                searching: false,
                paging: false,
                aoColumns: [{ "bSortable": false, "aTargets": 'no-sort' }, null, { "bSortable": false }, null, null, { "bSortable": false }, null, { "bSortable": false }, null, { "bSortable": false }]
            });
        ...
        $(document).on("click", ".checkboxItem", function () {
            ...
            if ($(this).prop('checked')) {
                $(".btnsave, .btnremovehide, .btnreport, .btnspam, .btndelete").removeClass("disabled");
            } else {
                if (count < 1) {
                    $(".btnsave, .btnremovehide, .btnreport, .btnspam, .btndelete").addClass("disabled");
                }
            }
        });
